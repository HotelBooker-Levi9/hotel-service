...
insert into hotel(id,name,image_url,description,price_per_day,capacity,is_deleted,city_id) values(4,"Awesome hotel 2", "","Best price for good time", 55, 80, false,1);
